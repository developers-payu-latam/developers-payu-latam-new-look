---
title: Promociones - Consulta por cuenta, valor de la transacción y moneda ~ Argentina <img src="/images/illustrations/argentina_logo.png" width="50">
position: 3.11.17
description: API y SDK
---

~~~ get
GET https://api.payulatam.com/payments-api/rest/v4.9/pricing?accountId={accountId}&currency={currency}&amount={amount}
~~~

Ejemplo de petición y respuesta

~~~ get
GET https://sandbox.api.payulatam.com/payments-api/rest/v4.9/pricing?accountId=512322&currency=ARS&amount=100
~~~
...
~~~ json
{
   ...
   "promotions":[
      {
         "id":347,
         "title":"Prueba promocion",
         "termsAndConditions":"Promoción de ahorro de 10%",
...
<consultPriceListResponse xmlns:atom="http://www.w3.org/2005/Atom" xmlns:ns3="http://wadl.dev.java.net/2009/02">
   ...
   <promotions>
      <promotion id="123" title="Prueba subfranquicia">
         <priority>10</priority>
         <type>MSI</type>
         <paymentMethod>MASTERCARD</paymentMethod>
         <termsAndConditions>Prueba subfranquicia</termsAndConditions>
         <subFranchise>CENCOSUD</subFranchise>
   ...
   <paymentMethodFee>
      <paymentMethodFeeDetail paymentMethod="MASTERCARD">
         <pricingFees>
            <fee installments="1">
               <pricing>
                  <payerDetail>
